...
class ConnectionEvent(Event):
    """Connection lifecycle event, inheriting from Event."""
...
class ConnectionEventManager:
    ...
    def __init__(self, logger: Optional[AppLogger] = None):
        ...
        self._context = LogContext(component="ConnectionEventManager")
    ...
    def start_dispatching(self) -> None:
        ...
        with self._lock:
            ...
            self._dispatcher_executor = ThreadPoolExecutor(
                max_workers=1, thread_name_prefix="event-dispatcher"
            )
    ...
    def _dispatch_events(self) -> None:
        ...
        while self._running:
            try:
                ...
                # Error in event dispatching - log and continue to prevent thread death
                self._logger.error(
                    f"Error in event dispatcher thread: {e}",
                    context=LogContext(
                        component=self._context.component, operation="dispatch_events"
                    ),
                    exc_info=True,
                )
                continue
            ...
            try:
                ...
                self._logger.error(
                    ...
                    context=LogContext(
                        ...
                        operation="dispatch_to_listeners",
                    ),
                    exc_info=True,
                    event_type=event_data.connection_event_type.value,

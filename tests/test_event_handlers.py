...
class TestLoggingEventHandler:
    ...
    def test_logging_event_handler_basic_functionality(self):
        """Test that LoggingEventHandler logs events correctly."""
        # Arrange
    ...
    def test_logging_event_handler_custom_logger_name(self):
        """Test LoggingEventHandler with custom logger name."""
        # Arrange
        from pipedoc.event_handlers import LoggingEventHandler
        
        with patch('logging.getLogger') as mock_get_logger:
            handler = LoggingEventHandler(logger_name="custom.logger")
    ...
    def test_logging_event_handler_different_event_types(self):
        """Test LoggingEventHandler with different event types."""
        # Arrange
        from pipedoc.event_handlers import LoggingEventHandler
    ...
    def test_logging_event_handler_with_metadata(self):
        """Test LoggingEventHandler includes metadata in log messages."""
        # Arrange
        from pipedoc.event_handlers import LoggingEventHandler
...
class TestFileEventHandler:
    """Test cases for FileEventHandler."""
    
    def test_file_event_handler_basic_functionality(self):
        """Test that FileEventHandler writes events to file."""
        # Arrange
        from pipedoc.event_handlers import FileEventHandler
        
        with tempfile.NamedTemporaryFile(mode='w', delete=False) as temp_file:
            temp_path = temp_file.name
        
        try:
            handler = FileEventHandler(temp_path)
    ...
    def test_file_event_handler_json_format(self):
        """Test FileEventHandler with JSON format."""
        # Arrange
        from pipedoc.event_handlers import FileEventHandler
        import json
        ...
        try:
            handler = FileEventHandler(temp_path, format='json')
    ...
    def test_file_event_handler_append_mode(self):
        """Test FileEventHandler appends to existing file."""
        # Arrange
        from pipedoc.event_handlers import FileEventHandler
    ...
    def test_file_event_handler_cleanup(self):
        """Test FileEventHandler cleanup closes file handle."""
        # Arrange
        from pipedoc.event_handlers import FileEventHandler
...
class TestStatisticsEventHandler:
    """Test cases for StatisticsEventHandler."""
    
    def test_statistics_event_handler_basic_functionality(self):
        """Test that StatisticsEventHandler collects statistics."""
        # Arrange
        from pipedoc.event_handlers import StatisticsEventHandler
        
        handler = StatisticsEventHandler()
        
        events = [
            ConnectionEvent(ConnectionEventType.CONNECT_ATTEMPT, "conn_1", time.time()),
            ConnectionEvent(ConnectionEventType.CONNECT_SUCCESS, "conn_1", time.time(), duration=0.1),
    ...
    def test_statistics_event_handler_timing_statistics(self):
        """Test StatisticsEventHandler tracks timing statistics."""
        # Arrange
        from pipedoc.event_handlers import StatisticsEventHandler
        ...
        for i, duration in enumerate(durations):
            handler.on_connection_event(ConnectionEvent(
                event_type=ConnectionEventType.CONNECT_SUCCESS,
    ...
    def test_statistics_event_handler_reset(self):
        """Test StatisticsEventHandler reset functionality."""
        # Arrange
        from pipedoc.event_handlers import StatisticsEventHandler
        ...
        # Add some data
        handler.on_connection_event(ConnectionEvent(
            ConnectionEventType.CONNECT_ATTEMPT, "test", time.time()
        ))
...
class TestEventHandlerIntegration:
    ...
    def test_multiple_event_handlers_integration(self):
        ...
        from pipedoc.event_handlers import LoggingEventHandler, StatisticsEventHandler
    ...
    def test_logging_event_handler_json_format(self):
        """Test LoggingEventHandler with JSON format."""
        # Arrange
        from pipedoc.event_handlers import LoggingEventHandler
        ...
        with patch('logging.getLogger') as mock_get_logger:
            ...
            handler = LoggingEventHandler(format_type="json")
...
class TestEventHandlerChain:
    ...
    def test_event_handler_chain_basic_functionality(self):
        ...
        # Arrange
        from pipedoc.event_handlers import EventHandlerChain, StatisticsEventHandler
        
        handler1 = StatisticsEventHandler()
        handler2 = StatisticsEventHandler()

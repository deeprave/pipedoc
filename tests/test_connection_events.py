...
class TestConnectionEventType:
    ...
    def test_connection_event_enum_properties(self):
        ...
        assert str(ConnectionEventType.CONNECT_ATTEMPT) == "ConnectionEventType.CONNECT_ATTEMPT"
...
class TestConnectionEventManager:
    ...
    def test_listener_error_isolation(self):
        ...
        failing_listener.on_connection_event.side_effect = RuntimeError("Listener error")

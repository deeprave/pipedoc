...
def demo_event_handler_chaining():
    ...
    error_logger = LoggingEventHandler(logger_name="pipedoc.errors", format_type="text")
...
def demo_custom_level_mapping():
    ...
    manager = PipeManager(max_workers=1, queue_size=3, event_listeners=[custom_logger])
